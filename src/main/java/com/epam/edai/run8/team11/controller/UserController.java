...
import com.epam.edai.run8.team11.dto.user.SignUpToUserMapper;
...
public class UserController {
    ...
    private final SignUpToUserMapper signUpToUserMapper;
    ...
    public ResponseEntity<Map<String, Object>> saveUser(@RequestBody SignUpDto signUpDto){
        ...
        User user = signUpToUserMapper.apply(signUpDto);
